...
return [
    ...
    */
    'server' => [
        ...
        'port' => env('SWOOLE_HTTP_PORT', '8058'),
        ...
        'options' => [
            ...
            'reactor_num' => env('SWOOLE_HTTP_REACTOR_NUM', 6),
            'worker_num' => env('SWOOLE_HTTP_WORKER_NUM', 12),
            'task_worker_num' => env('SWOOLE_HTTP_TASK_WORKER_NUM', 12),
