...
use Ophim\Core\Policies\ChapterReportPolicy;
use Ophim\Core\Policies\CommentPolicy;
...
use Ophim\Core\Policies\SettingPolicy;
use Ophim\Core\Policies\StudioPolicy;
use Ophim\Core\Policies\TagPolicy;
use Ophim\Core\Policies\TaxonomyPolicy;
...
class OphimServiceProvider extends ServiceProvider
{
    ...
    public function policies()
    {
        return [
            ...
            ChapterReport::class => ChapterReportPolicy::class,
